...
const url = 'http://vmi1116120.contaboserver.net:8888';

const json_rpc = new JsonRpc(url);
const private_key = '5HuSpLQm21aMKW7mtsDbiPJPa86VBPLfCVGMqXteWdKo4MNqT4M';
export const actor = 'oval';

export const account = 'oval';
